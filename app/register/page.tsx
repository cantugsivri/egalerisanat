  ...
  return (
    <div className="auth-layout">
      <div className="auth-card animate-fade-in">
        ...
        <p className="auth-subtitle">Sanat galerinizi oluşturmak için ilk adımı atın</p>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div className="form-group">
            <label className="form-label" htmlFor="name">Ad Soyad / Galeri Adı</label>
            <input
              id="name"
              type="text"
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="passwordConfirm">Şifre Tekrar</label>
            <input
              id="passwordConfirm"
              type="password"
              className="form-input"
